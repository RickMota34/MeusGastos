...
<head>
    ...
    <title>Inserir Janeiro</title>
</head>
<body>
    <div class="top-titulo">
        <h3>Inserir Janeiro</h3>
    </div>
            ...
            <form action="" method="post">
                <div class="mb-3">
                    <select name="form-pagmento" id="" class="form-control">
                        ...
                        <option value="" id="btn-action" class="nav-link">Cartão Crédito</option>
                    </select>
                </div>
                <div class="mb-3" id="credito" id="contid">
                ...
                <div class="mb-3">
                   <input type="text" class="form-control" placeholder="Qual o boleto">
                </div>
                <div class="mb-3">
                ...
                <!--input que serve para usar a busca no banco de dados-->
                <input type="hidden" name="id-busca" value="1">
            </form>
      </div>
